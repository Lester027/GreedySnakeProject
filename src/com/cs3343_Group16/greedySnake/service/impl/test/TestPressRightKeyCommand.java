...
public class TestPressRightKeyCommand {
	...
	public void testGetInstance() {
		KeyCommand p=PressRightKeyCommand.getInstance();
		assertEquals(PressRightKeyCommand.class,p.getClass());
	}
	...
	public void testExecute() {
		...
		PressRightKeyCommand.getInstance().execute(g);
